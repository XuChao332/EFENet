...
1. We present an advanced framework combining vision transformer and HRNet, a one-shot, end-to-end trainable, multi-scale approach incorporating the most recent HRFormer results.
2. We present an efficient feature enhancement module (EFEM) that combines rich degree scale feature information with sub-pixel convolution for feature map dimension extension. Interpolation upsampling error is avoided.
3. The feature improvement module can reduce the model’s influence on heat map post-processing, reduce the Quantization error generated by the model, and significantly reduce the model’s reliance on the post-processing approach.
</br>

![Illustrating the architecture of the proposed EFENet](/figures/.EFENetpng)
## Main Results
### Results on MPII val
...
| **pose_hrnet_w48** | 63.6M   |   14.6 | 0.751 | 0.906 |  0.822 |  0.715 |  0.818 | 0.804 | 0.943 |  0.867 |  0.762 |  0.864 |
| ***Our-S***        |  7.8M   |   3.07 | 0.753 | 0.925 |  0.825 |  0.722 |  0.807 | 0.783 | ----- | ------ |  ----- |  ----- |
| ***Our-B***        | 43.9M   |   12.9 | 0.770 | 0.935 |  0.836 |  0.737 |  0.821 | 0.798 | ----- | ------ |  ----- |  ----- |
